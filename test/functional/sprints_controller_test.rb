...
class SprintsControllerTest < ActionController::TestCase
  ...
  test "should create sprint" do
    assert_difference('Sprint.count') do
      post :create, sprint: { description: @sprint.description, team_id: @sprint.team_id, title: @sprint.title }
    end
  ...
  test "should update sprint" do
    put :update, id: @sprint, sprint: { description: @sprint.description, team_id: @sprint.team_id, title: @sprint.title }
    assert_redirected_to sprint_path(assigns(:sprint))
  end
